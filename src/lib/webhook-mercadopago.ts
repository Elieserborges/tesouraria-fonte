...
/**
 * Trata uma notificação do Mercado Pago.
 *
 * Fica fora do arquivo de rota porque duas URLs chegam aqui: a descritiva e
 * uma curta. O painel do Mercado Pago corta o endereço em 50 caracteres, e a
 * descritiva tem 64 — foi assim que a URL cadastrada virou um 404 silencioso.
 */
export async function tratarNotificacao(request: NextRequest, slug: string) {
